...
const routes = ["", "/features", "/pricing", "/availability", "/download", "/faq", "/security", "/support", "/contact", "/privacy", "/terms", "/account-deletion", "/cookies", "/acceptable-use", "/accessibility", "/financial-disclosures"] as const;
